        ...
        <>
            <Row className="align-items-center justify-content-center d-flex mt-5" xs="12" md="12" lg="12">
                ...
                <Col className="text-center" xs="12" md="1" lg="1">
                    <h3 className="font-weight-bolder text-danger-edit mr-5 ml-5 mt-3 mb-4" style={{ fontSize: "40px", borderTop: "4px solid" }}></h3>
                </Col>
            ...
            <Container fluid={true} className="bg-light pb-5">
                <Row className="align-items-center justify-content-center d-flex mt-5 mb-3" xs="12" md="12" lg="12">
                    <Col lg="4" md="4" xs="12">
                        <img src={preSchool} style={{ width: "350px" }} className="w-100 mb-5" />
                    </Col>
                ...
                <Row className="align-items-center justify-content-center d-flex" xs="12" md="12" lg="12">
                    <Col lg="7" md="7" xs="12">
                        <img src={gradeSchool1} style={{ width: "350px" }} className="w-100 mb-3" />
                        <img src={gradeSchool2} style={{ width: "350px" }} className="w-100 mb-5" />
                    </Col>
                ...
                <Row className="align-items-center justify-content-center d-flex mt-3" xs="12" md="12" lg="12">
                    <Col lg="7" md="7" xs="12" className="text-center">
                        <img src={highSchool4} style={{ width: "350px" }} className="w-100 mb-3" />
                        <img src={highSchool2} style={{ width: "350px" }} className="w-100 mb-5" />
                    </Col>
                </Row>
                ...
                <Row className="align-items-center justify-content-center d-flex mt-3" xs="12" md="12" lg="12">
                    ...
                    <Col lg="6" md="6" xs="12" className="text-center mt-3">
                        <img src={highSchool1} style={{ width: "350px" }} className="w-100 mb-3" />
                        <img src={highSchool3} style={{ width: "350px" }} className="w-100 mb-5" />
                    </Col>
                </Row>
            </Container>
        </>
...
export default MobileBasicAcads;
