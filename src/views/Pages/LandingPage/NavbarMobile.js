    ...
    return (
        <div style={{ height: "100%", position: "fixed", zIndex: "99999999", backgroundColor: "white", width: "100%", overflowY: "hidden", transition: "1s" }} className="fade-in justify-content-center align-items-center d-flex">
            ...
            <Row className="d-flex flex-column justify-content-center align-items-center">
                ...
                {/* <Button onClick={() => history.push('/admission-page')} className="text-danger-edit nav-mobile font-weight-bolder mb-4">ADMISSION</Button> */}
                ...
                {/* <Button onClick={() => history.push(window.open("http://mail.sapc.edu.ph/"))} className="text-danger-edit nav-mobile font-weight-bolder mb-4">UGNAI</Button>
                <Button onClick={() => history.push('/login')} className="text-danger-edit nav-mobile font-weight-bolder">SINAG LOGIN</Button> */}
            </Row>
        </div>
    );
}
